...
서비스 안정성과 성능 개선 중심의 개발을 지향하며, RESTful API 설계와 데이터 구조 개선을 통해 실제 서비스 품질을 높이는 경험을 쌓아왔습니다.

- 2년간 백엔드 개발자로 근무하며 **서비스 운영 및 성능 최적화 경험**
- Java, Spring Boot 기반 **RESTful API 설계 및 도메인 모델링**
- QueryDSL 기반 **쿼리 최적화 및 성능 개선 경험**
...
- **소개:** 부동산 매물 요청자와 중개사를 연결하는 부동산 매칭 플랫폼  
- **역할:** 백엔드 개발  
- **기술 스택:** Java, Spring Boot, JPA, QueryDSL, MySQL, GitHub Actions  

### 주요 성과

- 부동산 **매물 요청 / 등록 / 알림 / 관리자 기능 등 핵심 도메인 REST API 설계 및 구현**
- QueryDSL 기반 쿼리 최적화로 **DB 성능 30% 개선**
- API 평균 응답 속도 **약 400ms 단축**
